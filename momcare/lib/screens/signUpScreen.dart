        ...
        Padding(
          ...
          child: Container(
           ...
           child: Padding(
             ...
             child: Column(
              children: [
                const Text('Signup', textAlign: TextAlign.center,style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold,),),
                ...
                Padding(
                  ...
                  child: TextField(
                    controller: id,
                    decoration: const InputDecoration(hintText: 'Doc/Mid ID'),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 15),
